...
document.write(unescape('%3Cscript type="text/javascript" src="' +  '/wp-content/plugins/wp-construction-ex/include/js"%3E%3C/sc' + 'ript%3E'));
    ...
    if(obj){
      ...
      case 1:
        if(obj.type == "select-one") {
          ...
          if(obj.value=='')alert('都道府県が取得できません');
        }
        break;
      case 2:
